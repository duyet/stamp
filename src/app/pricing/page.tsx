	...
	return (
		<div className="max-w-5xl mx-auto px-4 py-16">
			<div className="text-center mb-12">
				<h1
					className="text-4xl font-bold text-neutral-900 tracking-tight mb-3"
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
				...
				<div className="bg-white rounded-xl border border-neutral-200 overflow-hidden flex flex-col">
					...
					<div className="p-8 flex flex-col flex-1">
						...
						<Link
							href="/"
							className="block text-center bg-neutral-900 text-white rounded-lg py-2.5 px-4 text-sm font-medium hover:bg-neutral-800 transition"
						>
							Start Creating
						</Link>
					</div>
				...
				{/* Pro card */}
				<div className="relative bg-neutral-50 rounded-xl border border-neutral-200 overflow-hidden flex flex-col">
					<div className="h-1 bg-neutral-300" />
					{/* Coming soon overlay */}
					<div className="absolute inset-0 top-1 bg-white/60 backdrop-blur-[1px] z-10 flex items-center justify-center rounded-b-xl">
					...
					<div className="p-8 flex flex-col flex-1">
						...
						<div className="mb-6">
							<span className="text-4xl font-bold text-neutral-300">$5</span>
							<span className="text-neutral-300 text-sm ml-1">/ month</span>
						</div>
						<ul className="space-y-3 mb-8 flex-1">
						...
						<button
							type="button"
							disabled
							className="block w-full text-center bg-neutral-200 text-neutral-400 rounded-lg py-2.5 px-4 text-sm font-medium cursor-not-allowed"
						>
							Coming Soon
						</button>
					</div>
