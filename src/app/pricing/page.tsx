		...
		<div className="max-w-5xl mx-auto px-6 py-20">
			...
			<div className="bg-stone-100 dark:bg-stone-800/50 rounded-2xl p-6 sm:p-10 max-w-3xl mx-auto">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					{/* Free card */}
					<div className="bg-white dark:bg-stone-900 rounded-2xl p-6 sm:p-8 flex flex-col shadow-sm">
						...
						<Link
							href="/"
							className="block text-center bg-stamp-navy dark:bg-stone-100 text-white dark:text-stone-900 rounded-xl py-3 px-6 text-sm font-medium hover:bg-stone-800 dark:hover:bg-stone-200 transition"
						>
							Start Creating
						</Link>
					</div>
					...
					{/* Pro card */}
					<div className="relative bg-stone-200/60 dark:bg-stone-700/50 rounded-2xl overflow-hidden flex flex-col">
						{/* Coming soon overlay */}
			...
			<p className="text-center text-stone-600 dark:text-stone-400 text-sm mt-14">
				...
				<a
					...
					className="text-stone-600 dark:text-stone-400 hover:text-stamp-navy dark:hover:text-stone-200 transition underline underline-offset-2"
				>
					Get in touch
				</a>
			</p>
